...
- Si en los dos nodos aparece `No applicable tools patches are available` → ya estás en la última versión, salta al punto 1.2.
- Si lista un parche disponible → continúa con el paso 3.

También puedes consultar la última versión publicada por Oracle:
